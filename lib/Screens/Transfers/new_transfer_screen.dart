...
class NewTransferenciaScreen extends StatefulWidget {


  // ignore: use_key_in_widget_constructors
  const NewTransferenciaScreen();

  @override
  State<NewTransferenciaScreen> createState() => _NewTransferenciaScreenState();
}

 class _NewTransferenciaScreenState extends State<NewTransferenciaScreen> {
